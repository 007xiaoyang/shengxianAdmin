...
if ($(".tooltip-demo").tooltip({
    ...
    var gohome = '<div class="gohome"><a class="animated bounceInUp" href="http://zorn.gdswww.com:88/manage.php/Login/index.shtml" title="返回首页"><i class="fa fa-home"></i></a></div>';
    $("body").append(gohome)
}
