                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="" method="POST">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input id="phone" name="phone"required=""  pattern="[0-9]{10}"  placeholder="输入账号" title="只能输入11位数字哟"  class="form-control" type="text" required="true" class="valid" value="">

                            </div>
                            <span style="color: #AF2018 ;font-size: 15px ">*格式是：11位</span>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">密码：</label>
                            <div class="col-sm-6">
                                <input id="pwd" name="pwd"  placeholder="输入密码" title="只能输入密码"  class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">确认密码：</label>
                            <div class="col-sm-6">
                                <input id="pwd2" name="pwd2"  placeholder="确认密码" title="只能输入密码"  class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn btn-primary postfrom" id="addCustomer" type="button">
