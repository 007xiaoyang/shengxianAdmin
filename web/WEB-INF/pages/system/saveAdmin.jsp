                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="account" name="account"  placeholder="请输入账号" class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">用户名：</label>
                            <div class="col-sm-9">
                                <input id="nick" name="username"  placeholder="请输入用户名" class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="password" class="form-control" placeholder="请确认密码" id="confirm_password" name="confirm_password"/>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-3">
                                <select class="form-control" name="adminRoleId" id="adminRoleId">
                                    <c:forEach items="${adminRoles}" var="adminRole">
                                        <option value="${adminRole.get("id")}">${adminRole.get("rolename")}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn btn-primary postfrom" id="saveAdmin" type="button">
