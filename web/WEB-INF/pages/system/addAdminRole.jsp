                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="lastname" name="rolename"  placeholder="请输入角色名" class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <c:forEach items="${adminList.listTwo}" var="listTwo">
                                            <div class="col-sm-2" >
                                                <label><input type="checkbox" class="i-checks role${listTwo.id}" name="adminListIds" value="${listTwo.id}">${listTwo.name}</label>
                                            </div>
                                        </c:forEach>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn btn-primary postfrom" type="button" id="addAdminRole">
