                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="account" name="account"  placeholder="请输入角色名称" class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn btn-primary postfrom" id="saveRole" type="button">
