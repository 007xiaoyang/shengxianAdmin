                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t" id="signupForm" action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input id="account" name="code"  placeholder="可以为空" class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">菜单名称：</label>
                            <div class="col-sm-9">
                                <input id="nick" name="name"  placeholder="菜单名称" class="form-control" type="text" required="true" class="valid" value="">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="请求地址" id="link" name="link"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">排序：</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="排序" id="sort" name="sort"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">层级：</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="层级" id="level" name="level"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label">父级编号：</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" placeholder="层级" id="menuid" name="menuid"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-8 col-sm-offset-2">
                                <button class="btn btn-primary postfrom" id="addMenua" type="button">
