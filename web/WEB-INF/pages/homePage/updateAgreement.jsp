                    ...
                    <form class="form-horizontal m-t" id="signupForm" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group">
                                ...
                                <h2 class="col-sm-5 control-label">协议内容</h2>
                                <div class="col-sm-12 noticeContent">
                                    <textarea name="content" name="内容"  value="" id="noEd" style="display: none">
                                    </textarea>
                                    <textarea name="content" name="内容"  value="" id="editor" style="width: 100%; height:800px; ">
                                    </textarea>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="col-sm-12 col-sm-offset-2">
                                <button class="col-sm-4 btn btn-primary updateContent" type="button">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button"  class="btn btn-primary updateAgreement" >
                        确认
                    </button>
                </div>
            </div><!-- /.modal-content -->
