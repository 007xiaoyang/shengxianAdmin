                ...
                <div class="ibox-content">
                    <div class="form-horizontal">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group" style="margin: 10px 0px 30px 180px">
                                    <label class="col-sm-2 control-label">所属：</label>
                                    <div class="col-sm-3">
                                        <select class="form-control" name="distinguish" id="distinguish">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3 touxiang">
                                        <img id="img" class="grxx_tx" src="../statics/img/jiahao.png" style="width:150px;height:150px;cursor:pointer;">
                                    </div>
                                </div>
                                <div class="form-group" style="margin:30px 0px 30px 180px">
                                    ...
                                    <div class="col-sm-2">
                                        <input id="sort" name="sort"  placeholder="" class="form-control" type="text" required="true" class="valid" value="">
                                    </div>
                                </div>

                                <div class="form-group" style="margin-left: 100px">
                                    <div class="col-sm-8 col-sm-offset-2">
                                        <button class="btn btn-primary postfrom" id="addTheme" type="button">
...
<script src="${pageContext.request.contextPath}/statics/js/myjs/backgroundImageLsit.js"></script>
    <script type="text/javascript">
        ...
        $(document).on("click","#addTheme",function () {
            ...
            $.ajax({
                type: "POST",
                url: "../homePage/addBackgroundImage.do",
                data:{figure:figure,distinguish:distinguish,sort:sort},
