...
<script src="${pageContext.request.contextPath}/statics/js/myjs/witnesses.js"></script>
...
<script type="text/javascript">
    ...
    $(document).on("click",".search",function () {
        ...
        findWitnesses(1,"",store_name);
    });
    //点击页数
    function funWitnesses(){
        $("#pagecount span a").on('click',function(){
            var store_name = $("#store_name").val();
            var rel = $(this).attr("rel");
            if(rel){
                findWitnesses(rel,"",store_name);
            }
        });
    };
