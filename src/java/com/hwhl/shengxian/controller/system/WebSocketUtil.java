...
public class WebSocketUtil {
	...
	public void onMessage(String message) throws IOException {
		...
		if (!jsonTo.getString("token").equals("All")){
			log.info("单方推送");
			sendMessageTo(mes, jsonTo.getString("token"));
		}else{
			sendMessageAll(mes);
			log.info("给所有人");
		}
	...
	public static void setOnlineCount(int onlineCount) {WebSocketUtil.onlineCount = onlineCount;}
